# pygame demo 7b SimpleButton test
...
oButtonA = SimpleButton(window, (25, 30 ), 'buttons/buttonUp.png', 'buttons/buttonDown.png')
oButtonB = SimpleButton(window, (150, 30 ), 'buttons/buttonUp.png', 'buttons/buttonDown.png')
oButtonC = SimpleButton(window, (275, 30 ), 'buttons/buttonUp.png', 'buttons/buttonDown.png')
